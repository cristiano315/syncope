...
/**
 * Randoop harness for {@link Neo4jRealmSearchDAO2}.
 *
 ...
 * bootstrapping.</p>
 */
public final class Neo4jRealmSearchDAO2Harness {

    private Neo4jRealmSearchDAO2Harness() {
        // Utility class for Randoop: do not instantiate.
    }

    public static Neo4jRealmSearchDAO2 newDaoWithNullDependencies() {
        return new Neo4jRealmSearchDAO2(null, null, null, null, null, null, null, null, null);
    }

    public static String setParameterOnNewMap(final Object parameter) {
        Map<String, Object> parameters = new HashMap<>();
        String name = Neo4jRealmSearchDAO2.setParameter(parameters, parameter);
    ...
    public static String setParameterOnMap(final Map<String, Object> parameters, final Object parameter) {
        ...
        try {
            String name = Neo4jRealmSearchDAO2.setParameter(safeParameters, parameter);
    ...
    public static String escapeIfString(final String value, final boolean stringValue) {
        try {
            return Neo4jRealmSearchDAO2.escapeIfString(value, stringValue);
        } catch (RuntimeException e) {
            return failure(e);
        }
    }
    ...
    public static String appendPlainAttrCond(final String cond) {
        try {
            ...
            Neo4jRealmSearchDAO2.appendPlainAttrCond(query, null, cond);
    ...
    public static String queryOp(final String op, final String leftQuery, final String rightQuery) {
        try {
            TextStringBuilder query = new TextStringBuilder();
            Neo4jRealmSearchDAO2.queryOp(query, op, queryInfo(leftQuery, null), queryInfo(rightQuery, null));
            return query.toString();
        } catch (RuntimeException e) {
            return failure(e);
        }
    ...
    public static String wrapQuery(final Set<String> bases, final String innerQuery, final String orderProperty) {
        try {
            ...
            Neo4jRealmSearchDAO2.QueryInfo queryInfo = queryInfo(innerQuery, null);
    ...
    public static String getSearchCondQuery(final SearchCond cond) {
        try {
            Map<String, Object> parameters = new HashMap<>();
            Neo4jRealmSearchDAO2.QueryInfo queryInfo = newDaoWithNullDependencies().getQuery(cond, parameters);
    ...
    public static String getAttrCondQuery(final AttrCond cond, final boolean not) {
        try {
            Map<String, Object> parameters = new HashMap<>();
            Neo4jRealmSearchDAO2.AttrCondQuery query = newDaoWithNullDependencies().getQuery(cond, not, parameters);
    ...
    public static String getAnyCondQuery(final AnyCond cond, final boolean not) {
        try {
            Map<String, Object> parameters = new HashMap<>();
            Neo4jRealmSearchDAO2.AnyCondQuery query = newDaoWithNullDependencies().getQuery(cond, not, parameters);
    ...
    private static Neo4jRealmSearchDAO2.QueryInfo queryInfo(final String query, final Set<String> fields) {
        return new Neo4jRealmSearchDAO2.QueryInfo(
