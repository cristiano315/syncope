...
/**
 * Randoop harness for {@link GroupMemberProvisionTaskJobDelegate4}.
 *
 ...
 */
public final class GroupMemberProvisionTaskJobDelegate4Harness {

    private GroupMemberProvisionTaskJobDelegate4Harness() {
        // Utility class for Randoop: do not instantiate.
    }

    public static GroupMemberProvisionTaskJobDelegate4 newDelegate() {
        return new GroupMemberProvisionTaskJobDelegate4();
    }

    public static String actionJobDetailKey() {
        return GroupMemberProvisionTaskJobDelegate4.ACTION_JOBDETAIL_KEY;
    }

    public static String groupKeyJobDetailKey() {
        return GroupMemberProvisionTaskJobDelegate4.GROUP_KEY_JOBDETAIL_KEY;
    }

    public static boolean stopSetsStopRequested() {
        GroupMemberProvisionTaskJobDelegate4 delegate = newDelegate();
        delegate.stop();
    ...
    private static Object readField(final GroupMemberProvisionTaskJobDelegate4 delegate, final String fieldName) {
        try {
            Field field = GroupMemberProvisionTaskJobDelegate4.class.getDeclaredField(fieldName);
    ...
    private static void setField(
            final GroupMemberProvisionTaskJobDelegate4 delegate,
    ...
    private static Object invoke(
        ...
        try {
            Method method = GroupMemberProvisionTaskJobDelegate4.class.getDeclaredMethod(methodName, parameterTypes);
