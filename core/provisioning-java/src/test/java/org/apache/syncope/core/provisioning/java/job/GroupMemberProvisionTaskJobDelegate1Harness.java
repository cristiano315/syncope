...
/**
 * Randoop harness for {@link GroupMemberProvisionTaskJobDelegate1}.
 *
 ...
 */
public final class GroupMemberProvisionTaskJobDelegate1Harness {

    private GroupMemberProvisionTaskJobDelegate1Harness() {
        // Utility class for Randoop: do not instantiate.
    }

    public static GroupMemberProvisionTaskJobDelegate1 newDelegate() {
        return new GroupMemberProvisionTaskJobDelegate1();
    }

    public static String actionJobDetailKey() {
        return GroupMemberProvisionTaskJobDelegate1.ACTION_JOBDETAIL_KEY;
    }

    public static String groupKeyJobDetailKey() {
        return GroupMemberProvisionTaskJobDelegate1.GROUP_KEY_JOBDETAIL_KEY;
    }

    public static boolean stopSetsStopRequested() {
        GroupMemberProvisionTaskJobDelegate1 delegate = newDelegate();
        delegate.stop();
    ...
    private static Object readField(final GroupMemberProvisionTaskJobDelegate1 delegate, final String fieldName) {
        try {
            Field field = GroupMemberProvisionTaskJobDelegate1.class.getDeclaredField(fieldName);
    ...
    private static void setField(
            final GroupMemberProvisionTaskJobDelegate1 delegate,
    ...
    private static Object invoke(
        ...
        try {
            Method method = GroupMemberProvisionTaskJobDelegate1.class.getDeclaredMethod(methodName, parameterTypes);
